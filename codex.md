...
- Session detail UI regression coverage now spans transcript lists, quality summaries, speaker stats, insight lists, graph-tree states plus branch-label/tooltips, snapshot tables, and local correction tools.
