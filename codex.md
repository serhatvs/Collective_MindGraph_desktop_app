...
- Session detail UI regression coverage now spans transcript lists, quality summaries, speaker stats, insight lists, graph-tree empty/orphan states, snapshot tables, and local correction tools.
