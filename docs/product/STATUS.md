...
- **Backend Service**: A local FastAPI background service (`realtime_backend/`) running on `127.0.0.1:8080`. It provides processing but is not the UI.
- **Developer Debugging**: The `/docs` endpoint at `127.0.0.1:8080/docs` is for API inspection only and is NOT the project frontend.
