...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark CMG ASR accuracy against a human reference transcript."
    )
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("docs/reports/2026-06-30/gpu-asr/ASR_ACCURACY_BENCHMARK_REPORT.md"),
    )
