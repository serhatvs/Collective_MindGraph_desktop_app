...
from collective_mindgraph.application.transcription.transcript_formatter import format_transcript
from collective_mindgraph.engine.settings import EngineSettings
from collective_mindgraph.infrastructure.transcription.asr import resolve_asr_quality_profile
...
DEFAULT_OUTPUT = (
    ...
    / "TRANSCRIPTION_QUALITY_REPORT.md"
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Profiles to run. Defaults to all supported profiles.",
    )
...
async def run_profile(
    ...
    try:
        ...
        transcript = await pipeline.process_audio_path(
            audio_path,
            source="benchmark_transcription_quality",
            language=language,
