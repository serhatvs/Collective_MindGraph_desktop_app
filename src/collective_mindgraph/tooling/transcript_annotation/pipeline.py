...
async def transcribe_for_annotation(
    ...
    *,
    ...
    settings_factory: Callable[[], EngineSettings] = EngineSettings,
    pipeline_factory: Callable[[EngineSettings], Any] = RecordingProcessor,
) -> Any:
...
def _apply_model_override(settings: EngineSettings, profile: str, model: str) -> None:
