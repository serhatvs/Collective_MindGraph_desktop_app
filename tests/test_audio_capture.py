...
from collective_mindgraph.desktop.audio_capture import (
    AutoStopConfig,
    SilenceWindowTracker,
    _read_incremental_pcm_level,
)
...
def test_read_incremental_pcm_level_reads_only_new_samples(tmp_path):
    ...
    next_rms, next_duration, next_consumed = _read_incremental_pcm_level(
        audio_path, byte_offset=consumed_bytes
    )
