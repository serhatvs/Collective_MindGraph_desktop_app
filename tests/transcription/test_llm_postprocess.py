...
from collective_mindgraph.infrastructure.transcription import llm_postprocess as llm_module
...
def test_auto_local_llm_provider_falls_back_to_mock_cleanup():
    provider = AutoLocalLLMProvider(EngineSettings())
...
def test_build_llm_postprocessor_defaults_to_disabled():
    processor = llm_module.build_llm_postprocessor(EngineSettings())

    assert processor.provider_name == "none"
