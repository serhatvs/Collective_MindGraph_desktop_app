...
def test_turkish_structured_extraction():
    ...
    transcript = ConversationTranscript(
        conversation_id="test_structured", source="test", segments=segments, language="tr"
    )
...
def test_extraction_uses_corrected_text_default():
    ...
    transcript = ConversationTranscript(
        conversation_id="test_fallback", source="test", segments=segments
    )
    service = ExtractTranscriptInsights()
...
def test_extraction_falls_back_to_raw_text():
    ...
    transcript = ConversationTranscript(
        conversation_id="test_fallback_raw", source="test", segments=segments
    )
    service = ExtractTranscriptInsights()
